...
1. Pull, but you have local work
    ...
    - If have Conflict in the file will show below :
    
      + For Local work is committed (A--B--D): 
      
      ![conflict](src/conflict.png)
      ...
      ![conflict2](src/conflict2.png)
      
         - commit them first and follow previous committed solution (Recommand) **or**
