...
- a .gitignore file
- an RStudio Project
- any files you upload into remote repository
...
(explain for archive purpose vs working location)
...
## Main branch
The main branch contains the base code template that will be updated at the end each round, so we need to upload/push the initial files at beginning. After all files settle done, we should not touch this branch. At the end of the round, a workshop will be hold to compare the files in different branches using **Notepad++** and decide the merge request before merging the subbranch to main.

![main](src/main.png)
Screenshot for branch in GitHub and Local
...
2. Copy the data folders into your working directory
