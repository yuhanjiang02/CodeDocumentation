...
#### Main branch
The main branch contains the base code template that will be updated during each round. There will have a workshop to compare the files using [Notepad++](#notepad) and decide the merge request before merging the subbranch to main.
