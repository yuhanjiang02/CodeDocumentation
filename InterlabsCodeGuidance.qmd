...
We can use Git client (e.x. GitKraken) to get a nice graphical overview of the recent commit history, branches, and diffs.
...
There are two ways to create a new branch in both local and remote:
  ...
  - From GitHub:
   ...
   - From Rstudio:
     ...
     Switch to the branch you want to branch off [(see switch branch section)](#switch_branch) then create branch followed by below image.
...
#### Fundamentals branch workflow {#switch_branch}
